...
import { CAN_COERCE_TO, COERCIONS, TYPE, VALID_OPERATORS } from './group'
...
describe('Group Data Type', () => {
  ...
  describe('VALID_OPERATORS', () => {
    it('allows IS operations against CATEGORY, GROUP, and TEXT data types', () => {
      expect(VALID_OPERATORS[operators.IS]).toEqual([CATEGORY, GROUP, TEXT])
    })
